...
% Grid dimensions:
%
lonmin =   27;   % Minimum longitude [degree east]
lonmax =  35;   % Maximum longitude [degree east]
latmin = -120;   % Minimum latitude  [degree north]
latmax = -110;   % Maximum latitude  [degree north]
%
...
%
CROCOTOOLS_dir = '/HOME/users/aparco/CROCO/croco_tools-v1.3/';
%
%  Run directory
%
RUN_dir='/HOME/users/aparco/CROCO/CALIFORNIA_LR/';
%
...
%
DATADIR='/HOME/users/aparco/CROCO/croco_tools-v1.3/DATASETS_CROCOTOOLS/';
%
